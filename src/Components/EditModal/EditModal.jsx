...
export const EditModal = (props) => {
    ...
    <div className='modal-content'>
                <button className='closeBtn' onClick={() => props.openEditModal()}>X</button>
                <div className='left'>
                ...
                <div className='right'>
                   ...
                   <option value="Final">CV</option>
                    ...
                    <div className='report'>
                        <textarea className="reportNote" type="text" onChange={(event) => {
                    setBody({...body, note : event.target.value})
                }}>{modalData.note}</textarea>
                        <button className='submitChange' onClick={changeReport}>Submit</button>
                    </div>
                </div>
            </div>
    </div>
