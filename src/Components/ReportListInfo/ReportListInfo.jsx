...
export const ReportListInfo = (props) => {
  ...
  return (
    <div id={theme ? "ReportListInfo-light" : "ReportListInfo-dark"}>
      ...
      <img
        ...
        className="img-modal"
        src="https://cp.cuyahogacounty.us/media/1832/form.png?crop=0,0.026831272691590618,0.080070650574035979,0.053239377882445364&cropmode=percentage&width=300&height=300&rnd=131837411850000000"
        alt=""
      />
    </div>
  );
